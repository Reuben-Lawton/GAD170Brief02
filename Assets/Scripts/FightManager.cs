...
public class FightManager : MonoBehaviour
{
    ...
    private float ValueConstFloat = 100;
    private DanceTeam dancingTeam;
    /// <summary>
    ...
    public float SimulateBattle(Character charOne, Character charTwo)
    {
        ...
        {
            percentWonBy = ((float)(charOnePoints - charTwoPoints) / (float)100);
        ...
        {
            percentWonBy = ((float)(charTwoPoints - charOnePoints) / (float)100);
    ...
    IEnumerator Attack(Character teamACharacter, Character teamBCharacter)
    {
        ...
        {
            outcome = (ValueConstFloat - (teamABattlePoints - teamBBattlePoints) / (float)ValueConstFloat);
            winner = teamACharacter;
            defeated = teamBCharacter;
        ...
        {
            outcome = (ValueConstFloat - (teamBBattlePoints - teamABattlePoints) / (float)ValueConstFloat);
